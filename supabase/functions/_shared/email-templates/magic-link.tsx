...
export const MagicLinkEmail = ({
  ...
  <Html lang="nl" dir="ltr">
    <Head />
    <Preview>Je inloglink voor De Kunst van Netwerken</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Klik op onderstaande knop om in te loggen bij De Kunst van Netwerken. Deze link verloopt binnenkort.
        </Text>
